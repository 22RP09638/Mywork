...
class Patron {
    private static final int maxofborrowedbooks = 3;
    private static final double LATE_FEE = 0.50; // Late fee per day

    private String name;
    private Book[] borrowedBooks;
    private int nofborrowedbooks;

    public Patron(String name) {
        this.name = name;
        this.borrowedBooks = new Book[maxofborrowedbooks];
        this.nofborrowedbooks = 0;
    }

    // Method to borrow a book
    public void borrowBook(Book book) {
        if (nofborrowedbooks < maxofborrowedbooks) {
            borrowedBooks[nofborrowedbooks] = book;
            nofborrowedbooks++;
    ...
    public String toString() {
        ...
        for (int i = 0; i < nofborrowedbooks; i++) {
